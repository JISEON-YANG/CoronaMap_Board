pipeline {
    ...
    stages {
        ...
        stage('tag'){
            steps{
                sh 'docker tag board:latest 783845918471.dkr.ecr.ap-northeast-2.amazonaws.com/board:0.8'
            }
        }

        stage('push'){
            steps{
                sh 'docker push 783845918471.dkr.ecr.ap-northeast-2.amazonaws.com/board:0.8'
            }
        }
    }
}